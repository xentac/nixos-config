...

{
  ...
  boot.initrd.luks.devices."cryptroot".device = "/dev/disk/by-uuid/7d26cd14-9158-420f-920b-d69fd2fbdd28";
  ...
  boot.initrd.luks.devices."cryptswap".device = "/dev/disk/by-uuid/84b6169e-d6ec-4910-9a5e-91518ceca6f6";
